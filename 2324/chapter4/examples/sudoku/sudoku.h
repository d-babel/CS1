...
//period colors
#define FG_PERIOD COLOR_YELLOW
#define BG_PERIOD COLOR_BLACK
...
enum { PAIR_BANNER = 1, PAIR_GRID, PAIR_BORDER, PAIR_LOGO, PAIR_DIGITS , PAIR_USER_NUM, PAIR_PERIODS, PAIR_WIN};
